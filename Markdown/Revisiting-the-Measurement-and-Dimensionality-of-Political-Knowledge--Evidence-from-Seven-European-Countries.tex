...
%
%
\thanksbycode{Both authors contributed equally to the development,
...
Romania, Spain, Sweden, UK) that, unusually, includes knowledge
...
analyses suggest that the two sets of questions are plausibly
...
political as well as immigration knowledge by aforementioned respondent
features exhibit similar patterns with independent scales measuring
knowledge on public health and climate change, suggesting that the
evidence from the previous steps was not an artefact of immigration
