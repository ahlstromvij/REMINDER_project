...
# germany
m_gen_germany <- lm(free_move_protect_jobs ~ know_score_general_binary +
                      gender +
                      age +
                      education_ISCED +
                      in_paid_work +
...
m_imm_germany <- lm(free_move_protect_jobs ~ know_score_imm_binary +
                      gender +
                      age +
                      education_ISCED +
                      in_paid_work +
...
# hungary
m_gen_hungary <- lm(free_move_protect_jobs ~ know_score_general_binary +
                      gender +
                      age +
                      education_ISCED +
                      in_paid_work +
...
m_imm_hungary <- lm(free_move_protect_jobs ~ know_score_imm_binary +
                      gender +
                      age +
                      education_ISCED +
                      in_paid_work +
...
# poland
m_gen_poland <- lm(free_move_protect_jobs ~ know_score_general_binary +
                     gender +
                     age +
                     education_ISCED +
                     in_paid_work +
...
m_imm_poland <- lm(free_move_protect_jobs ~ know_score_imm_binary +
                     gender +
                     age +
                     education_ISCED +
                     in_paid_work +
...
# romania
m_gen_romania <- lm(free_move_protect_jobs ~ know_score_general_binary +
                      gender +
                      age +
                      education_ISCED +
                      in_paid_work +
...
m_imm_romania <- lm(free_move_protect_jobs ~ know_score_imm_binary +
                      gender +
                      age +
                      education_ISCED +
                      in_paid_work +
...
# spain
m_gen_spain <- lm(free_move_protect_jobs ~ know_score_general_binary +
                    gender +
                    age +
                    education_ISCED +
                    in_paid_work +
...
m_imm_spain <- lm(free_move_protect_jobs ~ know_score_imm_binary +
                    gender +
                    age +
                    education_ISCED +
                    in_paid_work +
...
# sweden
m_gen_sweden <- lm(free_move_protect_jobs ~ know_score_general_binary +
                     gender +
                     age +
                     education_ISCED +
                     in_paid_work +
...
m_imm_sweden <- lm(free_move_protect_jobs ~ know_score_imm_binary +
                     gender +
                     age +
                     education_ISCED +
                     in_paid_work +
...
# uk
m_gen_uk <- lm(free_move_protect_jobs ~ know_score_general_binary +
                 gender +
                 age +
                 education_ISCED +
                 in_paid_work +
...
m_imm_uk <- lm(free_move_protect_jobs ~ know_score_imm_binary +
                 gender +
                 age +
                 education_ISCED +
                 in_paid_work +
