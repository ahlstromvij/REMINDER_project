...
# germany
m_econ_gen_germany <- lm(free_move_protect_services ~ know_score_general_binary +
                           gender +
                           age +
                           education_ISCED +
                           in_paid_work +
...
m_econ_imm_germany <- lm(free_move_protect_services ~ know_score_imm_binary +
                           gender +
                           age +
                           education_ISCED +
                           in_paid_work +
...
# hungary
m_econ_gen_hungary <- lm(free_move_protect_services ~ know_score_general_binary +
                           gender +
                           age +
                           education_ISCED +
                           in_paid_work +
...
m_econ_imm_hungary <- lm(free_move_protect_services ~ know_score_imm_binary +
                           gender +
                           age +
                           education_ISCED +
                           in_paid_work +
...
# poland
m_econ_gen_poland <- lm(free_move_protect_services ~ know_score_general_binary +
                           gender +
                           age +
                           education_ISCED +
                           in_paid_work +
...
m_econ_imm_poland <- lm(free_move_protect_services ~ know_score_imm_binary +
                           gender +
                           age +
                           education_ISCED +
                           in_paid_work +
...
# romania
m_econ_gen_romania <- lm(free_move_protect_services ~ know_score_general_binary +
                          gender +
                          age +
                          education_ISCED +
                          in_paid_work +
...
m_econ_imm_romania <- lm(free_move_protect_services ~ know_score_imm_binary +
                          gender +
                          age +
                          education_ISCED +
                          in_paid_work +
...
# spain
m_econ_gen_spain <- lm(free_move_protect_services ~ know_score_general_binary +
                           gender +
                           age +
                           education_ISCED +
                           in_paid_work +
...
m_econ_imm_spain <- lm(free_move_protect_services ~ know_score_imm_binary +
                           gender +
                           age +
                           education_ISCED +
                           in_paid_work +
...
# sweden
m_econ_gen_sweden <- lm(free_move_protect_services ~ know_score_general_binary +
                           gender +
                           age +
                           education_ISCED +
                           in_paid_work +
...
m_econ_imm_sweden <- lm(free_move_protect_services ~ know_score_imm_binary +
                           gender +
                           age +
                           education_ISCED +
                           in_paid_work +
...
# uk
m_econ_gen_uk <- lm(free_move_protect_services ~ know_score_general_binary +
                           gender +
                           age +
                           education_ISCED +
                           in_paid_work +
...
m_econ_imm_uk <- lm(free_move_protect_services ~ know_score_imm_binary +
                           gender +
                           age +
                           education_ISCED +
                           in_paid_work +
...
df_germany_effect <- data.frame(model_data_germany$free_move_protect_services, model_data_germany$WEIGHTEX1)
...
df_germany_effect_imm <- data.frame(model_data_germany$free_move_protect_services, model_data_germany$WEIGHTEX1)
...
# hungary
df_hungary_effect <- data.frame(model_data_hungary$free_move_protect_services, model_data_hungary$WEIGHTEX1)
...
df_hungary_effect_imm <- data.frame(model_data_hungary$free_move_protect_services, model_data_hungary$WEIGHTEX1)
...
# poland
df_poland_effect <- data.frame(model_data_poland$free_move_protect_services, model_data_poland$WEIGHTEX1)
...
df_poland_effect_imm <- data.frame(model_data_poland$free_move_protect_services, model_data_poland$WEIGHTEX1)
...
# romania
df_romania_effect <- data.frame(model_data_romania$free_move_protect_services, model_data_romania$WEIGHTEX1)
...
df_romania_effect_imm <- data.frame(model_data_romania$free_move_protect_services, model_data_romania$WEIGHTEX1)
...
# spain
df_spain_effect <- data.frame(model_data_spain$free_move_protect_services, model_data_spain$WEIGHTEX1)
...
df_spain_effect_imm <- data.frame(model_data_spain$free_move_protect_services, model_data_spain$WEIGHTEX1)
...
# sweden
df_sweden_effect <- data.frame(model_data_sweden$free_move_protect_services, model_data_sweden$WEIGHTEX1)
...
df_sweden_effect_imm <- data.frame(model_data_sweden$free_move_protect_services, model_data_sweden$WEIGHTEX1)
...
# uk
df_uk_effect <- data.frame(model_data_uk$free_move_protect_services, model_data_uk$WEIGHTEX1)
...
df_uk_effect_imm <- data.frame(model_data_uk$free_move_protect_services, model_data_uk$WEIGHTEX1)
