...
m_econ_combo_germany <- lm(gen_imm_ess_good_bad ~ know_score_combo_binary +
                             gender +
                             age +
                             education_ISCED +
                             in_paid_work +
...
m_econ_combo_hungary <- lm(gen_imm_ess_good_bad ~ know_score_combo_binary +
                             gender +
                             age +
                             education_ISCED +
                             in_paid_work +
...
m_econ_combo_poland <- lm(gen_imm_ess_good_bad ~ know_score_combo_binary +
                            gender +
                            age +
                            education_ISCED +
                            in_paid_work +
...
m_econ_combo_romania <- lm(gen_imm_ess_good_bad ~ know_score_combo_binary +
                             gender +
                             age +
                             education_ISCED +
                             in_paid_work +
...
m_econ_combo_spain <- lm(gen_imm_ess_good_bad ~ know_score_combo_binary +
                           gender +
                           age +
                           education_ISCED +
                           in_paid_work +
...
m_econ_combo_sweden <- lm(gen_imm_ess_good_bad ~ know_score_combo_binary +
                            gender +
                            age +
                            education_ISCED +
                            in_paid_work +
...
m_econ_combo_uk <- lm(gen_imm_ess_good_bad ~ know_score_combo_binary +
                        gender +
                        age +
                        education_ISCED +
                        in_paid_work +
...
df_germany_effect_combo <- data.frame(model_data_germany$gen_imm_ess_good_bad, model_data_germany$WEIGHTEX1)
...
df_hungary_effect_combo <- data.frame(model_data_hungary$gen_imm_ess_good_bad, model_data_hungary$WEIGHTEX1)
...
df_poland_effect_combo <- data.frame(model_data_poland$gen_imm_ess_good_bad, model_data_poland$WEIGHTEX1)
...
df_romania_effect_combo <- data.frame(model_data_romania$gen_imm_ess_good_bad, model_data_romania$WEIGHTEX1)
...
df_spain_effect_combo <- data.frame(model_data_spain$gen_imm_ess_good_bad, model_data_spain$WEIGHTEX1)
...
df_sweden_effect_combo <- data.frame(model_data_sweden$gen_imm_ess_good_bad, model_data_sweden$WEIGHTEX1)
...
df_uk_effect_combo <- data.frame(model_data_uk$gen_imm_ess_good_bad, model_data_uk$WEIGHTEX1)
