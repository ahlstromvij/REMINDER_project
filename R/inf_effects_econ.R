...
# germany
m_gen_germany <- lm(gen_imm_ess_good_bad ~ know_score_general_binary +
                      gender +
                      age +
                      education_ISCED +
                      in_paid_work +
...
m_imm_germany <- lm(gen_imm_ess_good_bad ~ know_score_imm_binary +
                      gender +
                      age +
                      education_ISCED +
                      in_paid_work +
...
# hungary
m_gen_hungary <- lm(gen_imm_ess_good_bad ~ know_score_general_binary +
                      gender +
                      age +
                      education_ISCED +
                      in_paid_work +
...
m_imm_hungary <- lm(gen_imm_ess_good_bad ~ know_score_imm_binary +
                      gender +
                      age +
                      education_ISCED +
                      in_paid_work +
...
# poland
m_gen_poland <- lm(gen_imm_ess_good_bad ~ know_score_general_binary +
                     gender +
                     age +
                     education_ISCED +
                     in_paid_work +
...
m_imm_poland <- lm(gen_imm_ess_good_bad ~ know_score_imm_binary +
                     gender +
                     age +
                     education_ISCED +
                     in_paid_work +
...
# romania
m_gen_romania <- lm(gen_imm_ess_good_bad ~ know_score_general_binary +
                      gender +
                      age +
                      education_ISCED +
                      in_paid_work +
...
m_imm_romania <- lm(gen_imm_ess_good_bad ~ know_score_imm_binary +
                      gender +
                      age +
                      education_ISCED +
                      in_paid_work +
...
# spain
m_gen_spain <- lm(gen_imm_ess_good_bad ~ know_score_general_binary +
                    gender +
                    age +
                    education_ISCED +
                    in_paid_work +
...
m_imm_spain <- lm(gen_imm_ess_good_bad ~ know_score_imm_binary +
                    gender +
                    age +
                    education_ISCED +
                    in_paid_work +
...
# sweden
m_gen_sweden <- lm(gen_imm_ess_good_bad ~ know_score_general_binary +
                     gender +
                     age +
                     education_ISCED +
                     in_paid_work +
...
m_imm_sweden <- lm(gen_imm_ess_good_bad ~ know_score_imm_binary +
                     gender +
                     age +
                     education_ISCED +
                     in_paid_work +
...
# uk
m_gen_uk <- lm(gen_imm_ess_good_bad ~ know_score_general_binary +
                 gender +
                 age +
                 education_ISCED +
                 in_paid_work +
...
m_imm_uk <- lm(gen_imm_ess_good_bad ~ know_score_imm_binary +
                 gender +
                 age +
                 education_ISCED +
                 in_paid_work +
...
png(file="plots/effect_fea.png", width = 9, height = 6, units = 'in', res = 300)
png(file="plots/effect_econ.png", width = 9, height = 6, units = 'in', res = 300)
ggplot(df_knowledge, aes(nationality, effect)) +
  ...
  scale_x_discrete(labels=c("uk" = "UK", 
                            ...
                            "germany" = "Germany")) +
  labs(
    title = "Knowledge effect on economic perceptions",
  ) +
  coord_flip()
dev.off()
...
jpeg(file="plots/econ.jpeg", width=950, height=500)
