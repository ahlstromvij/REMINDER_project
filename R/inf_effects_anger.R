...
# germany
m_gen_germany <- lm(imm_anger ~ know_score_general_binary +
                           gender +
                           age +
                           education_ISCED +
                           in_paid_work +
...
m_imm_germany <- lm(imm_anger ~ know_score_imm_binary +
                           gender +
                           age +
                           education_ISCED +
                           in_paid_work +
...
# hungary
m_gen_hungary <- lm(imm_anger ~ know_score_general_binary +
                           gender +
                           age +
                           education_ISCED +
                           in_paid_work +
...
m_imm_hungary <- lm(imm_anger ~ know_score_imm_binary +
                           gender +
                           age +
                           education_ISCED +
                           in_paid_work +
...
# poland
m_gen_poland <- lm(imm_anger ~ know_score_general_binary +
                          gender +
                          age +
                          education_ISCED +
                          in_paid_work +
...
m_imm_poland <- lm(imm_anger ~ know_score_imm_binary +
                          gender +
                          age +
                          education_ISCED +
                          in_paid_work +
...
# romania
m_gen_romania <- lm(imm_anger ~ know_score_general_binary +
                           gender +
                           age +
                           education_ISCED +
                           in_paid_work +
...
m_imm_romania <- lm(imm_anger ~ know_score_imm_binary +
                           gender +
                           age +
                           education_ISCED +
                           in_paid_work +
...
# spain
m_gen_spain <- lm(imm_anger ~ know_score_general_binary +
                         gender +
                         age +
                         education_ISCED +
                         in_paid_work +
...
m_imm_spain <- lm(imm_anger ~ know_score_imm_binary +
                         gender +
                         age +
                         education_ISCED +
                         in_paid_work +
...
# sweden
m_gen_sweden <- lm(imm_anger ~ know_score_general_binary +
                          gender +
                          age +
                          education_ISCED +
                          in_paid_work +
...
m_imm_sweden <- lm(imm_anger ~ know_score_imm_binary +
                          gender +
                          age +
                          education_ISCED +
                          in_paid_work +
...
# uk
m_gen_uk <- lm(imm_anger ~ know_score_general_binary +
                      gender +
                      age +
                      education_ISCED +
                      in_paid_work +
...
m_imm_uk <- lm(imm_anger ~ know_score_imm_binary +
                      gender +
                      age +
                      education_ISCED +
                      in_paid_work +
...
jpeg(file="plots/effect_anger.jpeg", width=950, height=500)
ggplot(df_knowledge, aes(nationality, effect)) +
  ...
  labs(
    title = "Knowledge effect on anger",
  ) +
  coord_flip()
dev.off()
...
df_germany_effect <- data.frame(model_data_germany$imm_anger, model_data_germany$WEIGHTEX1)
...
df_germany_effect_imm <- data.frame(model_data_germany$imm_anger, model_data_germany$WEIGHTEX1)
...
# hungary
df_hungary_effect <- data.frame(model_data_hungary$imm_anger, model_data_hungary$WEIGHTEX1)
...
df_hungary_effect_imm <- data.frame(model_data_hungary$imm_anger, model_data_hungary$WEIGHTEX1)
...
# poland
df_poland_effect <- data.frame(model_data_poland$imm_anger, model_data_poland$WEIGHTEX1)
...
df_poland_effect_imm <- data.frame(model_data_poland$imm_anger, model_data_poland$WEIGHTEX1)
...
# romania
df_romania_effect <- data.frame(model_data_romania$imm_anger, model_data_romania$WEIGHTEX1)
...
df_romania_effect_imm <- data.frame(model_data_romania$imm_anger, model_data_romania$WEIGHTEX1)
...
# spain
df_spain_effect <- data.frame(model_data_spain$imm_anger, model_data_spain$WEIGHTEX1)
...
df_spain_effect_imm <- data.frame(model_data_spain$imm_anger, model_data_spain$WEIGHTEX1)
...
# sweden
df_sweden_effect <- data.frame(model_data_sweden$imm_anger, model_data_sweden$WEIGHTEX1)
...
df_sweden_effect_imm <- data.frame(model_data_sweden$imm_anger, model_data_sweden$WEIGHTEX1)
...
# uk
df_uk_effect <- data.frame(model_data_uk$imm_anger, model_data_uk$WEIGHTEX1)
...
df_uk_effect_imm <- data.frame(model_data_uk$imm_anger, model_data_uk$WEIGHTEX1)
...
jpeg(file="plots/anger.jpeg", width=950, height=500)
...
# equivalency test
bound <- 6*0.05 # 5% of scale (which ranges from 1-7)
alpha <- 0.025
