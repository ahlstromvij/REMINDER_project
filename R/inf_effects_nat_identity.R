...
m_imm_germany_vcov <- vcovHC(m_imm_germany, type="HC1")
coeftest(m_imm_germany, vcov = m_imm_germany_vcov)
df_knowledge$effect[df_knowledge$nationality=="germany" & df_knowledge$type=="immigration"] <- coeftest(m_imm_germany, vcov = m_imm_germany_vcov)[2,1]
coefci(m_imm_germany, vcov = m_imm_germany_vcov)
df_knowledge$lwr[df_knowledge$nationality=="germany" & df_knowledge$type=="immigration"] <- coefci(m_imm_germany, vcov = m_imm_germany_vcov)[2,1]
df_knowledge$upr[df_knowledge$nationality=="germany" & df_knowledge$type=="immigration"] <- coefci(m_imm_germany, vcov = m_imm_germany_vcov)[2,2]
par(mfrow = c(2, 2))
plot(m_imm_germany)
