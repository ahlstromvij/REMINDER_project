...
# germany
m_econ_gen_germany <- lm(eu_nat_identity ~ know_score_general_binary +
                           gender +
                           age +
                           education_ISCED +
                           in_paid_work +
...
m_econ_imm_germany <- lm(eu_nat_identity ~ know_score_imm_binary +
                           gender +
                           age +
                           education_ISCED +
                           in_paid_work +
...
m_econ_combo_germany <- lm(eu_nat_identity ~ know_score_combo_binary +
                             gender +
                             age +
                             education_ISCED +
                             in_paid_work +
...
# hungary
m_econ_gen_hungary <- lm(eu_nat_identity ~ know_score_general_binary +
                           gender +
                           age +
                           education_ISCED +
                           in_paid_work +
...
m_econ_imm_hungary <- lm(eu_nat_identity ~ know_score_imm_binary +
                           gender +
                           age +
                           education_ISCED +
                           in_paid_work +
...
m_econ_combo_hungary <- lm(eu_nat_identity ~ know_score_combo_binary +
                             gender +
                             age +
                             education_ISCED +
                             in_paid_work +
...
# poland
m_econ_gen_poland <- lm(eu_nat_identity ~ know_score_general_binary +
                          gender +
                          age +
                          education_ISCED +
                          in_paid_work +
...
m_econ_imm_poland <- lm(eu_nat_identity ~ know_score_imm_binary +
                          gender +
                          age +
                          education_ISCED +
                          in_paid_work +
...
m_econ_combo_poland <- lm(eu_nat_identity ~ know_score_combo_binary +
                            gender +
                            age +
                            education_ISCED +
                            in_paid_work +
...
# romania
m_econ_gen_romania <- lm(eu_nat_identity ~ know_score_general_binary +
                           gender +
                           age +
                           education_ISCED +
                           in_paid_work +
...
m_econ_imm_romania <- lm(eu_nat_identity ~ know_score_imm_binary +
                           gender +
                           age +
                           education_ISCED +
                           in_paid_work +
...
m_econ_combo_romania <- lm(eu_nat_identity ~ know_score_combo_binary +
                             gender +
                             age +
                             education_ISCED +
                             in_paid_work +
...
# spain
m_econ_gen_spain <- lm(eu_nat_identity ~ know_score_general_binary +
                         gender +
                         age +
                         education_ISCED +
                         in_paid_work +
...
m_econ_imm_spain <- lm(eu_nat_identity ~ know_score_imm_binary +
                         gender +
                         age +
                         education_ISCED +
                         in_paid_work +
...
m_econ_combo_spain <- lm(eu_nat_identity ~ know_score_combo_binary +
                           gender +
                           age +
                           education_ISCED +
                           in_paid_work +
...
# sweden
m_econ_gen_sweden <- lm(eu_nat_identity ~ know_score_general_binary +
                          gender +
                          age +
                          education_ISCED +
                          in_paid_work +
...
m_econ_imm_sweden <- lm(eu_nat_identity ~ know_score_imm_binary +
                          gender +
                          age +
                          education_ISCED +
                          in_paid_work +
...
m_econ_combo_sweden <- lm(eu_nat_identity ~ know_score_combo_binary +
                            gender +
                            age +
                            education_ISCED +
                            in_paid_work +
...
# uk
m_econ_gen_uk <- lm(eu_nat_identity ~ know_score_general_binary +
                      gender +
                      age +
                      education_ISCED +
                      in_paid_work +
...
m_econ_imm_uk <- lm(eu_nat_identity ~ know_score_imm_binary +
                      gender +
                      age +
                      education_ISCED +
                      in_paid_work +
...
m_econ_combo_uk <- lm(eu_nat_identity ~ know_score_combo_binary +
                        gender +
                        age +
                        education_ISCED +
                        in_paid_work +
...
df_germany_effect_combo <- data.frame(model_data_germany$eu_nat_identity, model_data_germany$WEIGHTEX1)
...
df_hungary_effect_combo <- data.frame(model_data_hungary$eu_nat_identity, model_data_hungary$WEIGHTEX1)
...
df_poland_effect_combo <- data.frame(model_data_poland$eu_nat_identity, model_data_poland$WEIGHTEX1)
...
df_romania_effect_combo <- data.frame(model_data_romania$eu_nat_identity, model_data_romania$WEIGHTEX1)
...
df_spain_effect_combo <- data.frame(model_data_spain$eu_nat_identity, model_data_spain$WEIGHTEX1)
...
df_sweden_effect_combo <- data.frame(model_data_sweden$eu_nat_identity, model_data_sweden$WEIGHTEX1)
...
df_uk_effect_combo <- data.frame(model_data_uk$eu_nat_identity, model_data_uk$WEIGHTEX1)
